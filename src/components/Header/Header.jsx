      ...
      <div className={`container ${style["header__container"]}`}>
        <nav className={style.nav}>
          <NavLink className={style["header-logo"]} to="/">
            <img
              className={style["header-logo__img"]}
              src={logo}
              alt="kapibaralab logo"
            />
            <span className={style["header-logo__text"]}>
